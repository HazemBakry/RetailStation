...
@Component({
  selector: 'app-hr-loans-payments',
  templateUrl: './hr-loans-payments.component.html',
  styleUrls: ['./hr-loans-payments.component.css']
})
export class HrLoansPaymentsComponent implements OnInit {
  VacationData: any[] = [];
