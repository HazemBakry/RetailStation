...
@Component({
  selector: 'app-hr-iqama-report',
  templateUrl: './hr-iqama-report.component.html',
  styleUrls: ['./hr-iqama-report.component.css']
})

export class HRIqamaReportComponent implements OnInit {
  // TitleList = ['الموارد البشرية', 'تقرير الموظفين'];
  showLoader: boolean = false;
  showExportLoader: boolean = false;
  filterList: FilterModel[] = [];
  TitleList = ['الموارد البشرية', 'تقرير تواريخ انتهاء الإقامة'];
