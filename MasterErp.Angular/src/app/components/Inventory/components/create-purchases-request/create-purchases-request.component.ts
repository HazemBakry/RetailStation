...
@Component({
  selector: 'app-create-purchases-request',
  templateUrl: './create-purchases-request.component.html',
  styleUrls: ['./create-purchases-request.component.css']
})


export class CreatePurchasesRequestComponent implements OnInit {
  BranchesList: any[] = [];
