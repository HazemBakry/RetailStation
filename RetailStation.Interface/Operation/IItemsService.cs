...
namespace RetailStation.Interface.Operation
{
    public interface IItemsService
    {
        ...
        #region Units
        ActionsResponseModel AddUnit(UnitModel model);
        ActionsResponseModel EditUnit(int UnitId,UnitModel model);
        ActionsResponseModel DeleteUnit(int UnitId);
        List<UnitModel> GetUnits_Data(SearchFilterModel model);
        #endregion
