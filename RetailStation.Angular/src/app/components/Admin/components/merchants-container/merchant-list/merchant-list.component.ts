...
import { MerchantsContainerComponent } from '../merchants-container.component';
...
export class MerchantListComponent implements OnInit {
  ...
  supplierModel: MerchantModel = {} as MerchantModel;
  ...
  //   if (this.supplierModel?.merchantId)
  ...
  //   this.adminService.CreateNewMerchant(this.supplierModel).subscribe(data => {
  //     if (data?.isSuccess) {
  ...
  // editNewMerchant() {
  //   this.showAddLoader = true;
  //   this.adminService.EditMerchant(this.supplierModel.merchantId, this.supplierModel).subscribe(data => {
  //     if (data?.isSuccess) {
  //       // this.formGroup?.reset();
  //       this.isUpdate = false;
  //       this.modalService?.dismissAll();
  ...
  fillEditForm(MerchantModel: MerchantModel) {
    ...
    this.formGroup.patchValue({
      supplierId: MerchantModel.merchantId,
      ...
      beginningBalance: MerchantModel.beginningBalance,
  ...
  // deleteMerchant() {
  //   this.showAddLoader = true;
  //   this.adminService.DeleteMerchant(this.selectedMerchantId).subscribe(data => {
  //     if (data?.isSuccess) {
  //       this.modalService?.dismissAll();
  //       this.loadData();
  //       this.toaster.success(data?.message);
