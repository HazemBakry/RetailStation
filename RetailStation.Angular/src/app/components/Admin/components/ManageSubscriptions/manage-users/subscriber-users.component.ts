...
import { RoleModel, AddUserRoleModel } from "src/app/components/Shared/models/RoleModel";
...
export class SubscriberUsersComponent implements OnInit {
  ...
  pagedResponse: PagedResponseModel<UserModel[]> = {
    results: [],
    filterList: [],
    pageSize: 25,
    currentPage: 1,
  ...
  getRoles() {
    this.subscriptionsService.getRoles(this.pagedResponse).subscribe(data => {
...
// import { PagedResponseModel } from 'src/app/Shared/Models/PagedResponseModel';
// import { SubscriptionsService } from '../../Services/subscriptions.service';
...
//   styleUrls: ['./subscriber-users.component.css']
// })
// export class SubscriberUsersComponent {
//   @ViewChild('AddUserSidePanel') Sidepanel: HTMLElement;
//   Products:any[]=['Pos System','Hr','Finance','Reports','Pos Manager'];
//   UsersData: any[] = [];
//   SubscriberId: any;
//   PageResponse: PagedResponseModel = {
//     currentPage: 1,
//     pageSize: 25,
//     searchText: '',
//     results:[]
//   }
//   constructor(private subscriptionsService: SubscriptionsService, private route: ActivatedRoute,private offcanvasService: NgbOffcanvas) { }

//   ngOnInit(): void {
//     this.SubscriberId = this.route.parent.snapshot.paramMap.get('SubscriberId')
//     this.getSubscriberUsers();
//   }
...
//   getSubscriberUsers() {
//     this.subscriptionsService.getSubscriberUsers(this.SubscriberId,this.PageResponse).subscribe(data => {
//       // this.UsersData = data;
//     });
//   }
// }