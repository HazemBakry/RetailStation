...
@Component({
  selector: 'app-received-items-details-report',
  templateUrl: './received-items-details-report.component.html',
  styleUrls: ['./received-items-details-report.component.css']
})
export class ReceivedItemsDetailsReportComponent implements OnInit {
  ...
  loadData() {
    ...
    this.inventoryService.GetReceivedItemsDetailsReport_Data(this.fromDate, this.toDate, this.pagedResponseModel).subscribe(data => {
  ...
  exportData() {
    ...
    this.inventoryService.GetReceivedItemsDetailsReport_Export(this.fromDate, this.toDate, this.pagedResponseModel).subscribe(data => {
      if (data.isSuccess) {
