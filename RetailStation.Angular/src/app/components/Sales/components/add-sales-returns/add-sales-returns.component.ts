...
@Component({
  ...
  templateUrl: './add-sales-returns.component.html',
  styleUrls: ['./add-sales-returns.component.css']
})

export class AddSalesReturnsComponent implements OnInit {
    TitleList = ['المبيعات', 'إنشاء فاتورة مرتجعات'];
