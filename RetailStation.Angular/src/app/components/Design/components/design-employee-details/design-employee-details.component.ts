...
@Component({
  selector: 'app-design-employee-details',
  templateUrl: './design-employee-details.component.html',
  styleUrls: ['./design-employee-details.component.css']
})
export class DesignEmployeeDetailsComponent implements OnInit {
  IqamaIssueList: any[] = [];
