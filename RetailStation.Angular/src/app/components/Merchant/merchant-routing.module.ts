...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'items', component: MerchantItemsComponent, },//canActivate: [AuthPageGuard], data: { pageName: 'Items' } },
      { path: 'promotions', component: MerchantPromotionsComponent, canActivate: [AuthPageGuard], data: { pageName: 'promotions' } },
