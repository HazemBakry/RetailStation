...
namespace MasterErp.Entities.Common.Finance.GeneralAccounts
{
    class ToWord
    {
        ...
        private string GetDecimalValue(string decimalPart)
        {
            ...
            {
                Currency.PartPrecision = 1;
            }
            else if (decimalPart.Length == 2)
            {
                Currency.PartPrecision = 2;
            }
            else if (decimalPart.Length == 3)
            {
                Currency.PartPrecision = 3;
            }
        ...
        private void ExtractIntegerAndDecimalParts()
        {
            ...
            if (splits.Length > 1)
            {
                if (splits[1].Length == 1)
                    _decimalValue = Convert.ToInt32(GetDecimalValue(splits[1] + "0"));
                else
        ...
        public string ConvertToEnglish()
        {
            ...
            decimalString = ProcessGroup(_decimalValue);
        ...
        public string ConvertToArabic()
        {
            ...
            decimalString = ProcessArabicGroup(_decimalValue, -1, 0);
            ...
            { // here we add currency part name depending on _intergerValue : 1 ,2 , 3--->10 , 11--->99
                ...
                string _deci_string = _decimalValue.ToString();
                int remaining100 = 0;

                if (_deci_string.Length == 1)
                    remaining100 = (int)(_decimalValue * 10 % 100);
                else
                    remaining100 = (int)(_decimalValue % 100);
