...
{
    public class EmployeeWeeklyShiftFlatModel
    {
    ...
    public class EmployeeWeeklyShiftModel
    {
        public int EmployeeId { get; set; }
        public string EmployeeCode { get; set; }
        public string EmployeeNameEN { get; set; }
        ...
        public string BranchNameAR { get; set; }
        public int? TotalCount { get; set; }
        public List<ShiftModel> WeekShifts { get; set; } = new List<ShiftModel>();
    }
    public class ShiftModel : CreatorModel
    {
        public int? EmployeeWeeklyShiftId { get; set; }
        public int EmployeeId { get; set; }
        public DateTime ShiftDate { get; set; }
