...
{
    public class DBContext_XX : DbContext
    {
        //private readonly IConfiguration Configuration;
        private readonly ITenantService _tenantService;
        private readonly string ConnectionString;

        public DBContext_XX(DbContextOptions<DBContext_XX> options, ITenantService tenantService)//, IConfiguration _configuration)
            : base(options)
        {
        ...
        public DBContext_XX(DbContextOptions<DBContext_XX> options, ITenantService tenantService, IHttpContextAccessor httpContextAccessor)
       : base(options)
        {
